...
- **misc**: Add loading to ThreeLogo, color tokens, custom token types, dumi preview action bar, fefactor import and code format, fix Highlighter style and add selection style, Refactor ActionsBar, Refactor ActionsBar, Refactor ChatInputArea, Refactor ChatList, refactor dumi docs layout, Refactor fluent emoji, Refactor promise to edge speech, remove monorepo, Replace CDN, rm @dqbd/tiktoken, Update package dependencies and replace 'lodash' with 'lodash-es', Update version to 'latest' for vendor assets, update zustand usage to v4.4, use `clipboard.writeText` to replace `copy-to-clipboard`, 优化到 react18 代码实现，重构 ChatItem 相关的代码.
...
- **wip**: Tts, tts.
- **misc**: Add "avatar" prop to FormItem and modify FormTitle component, Add "children" prop and update styles in ListItem component, Add "extra" prop to FormGroup component, Add "use-merge-value" and "useControlledState" hooks to ChatInputArea, Add @react-spring/three dependency and implement hover state and rotation in Logo.tsx, Add `BackToBottom`, add `CodeEditor`, add `Giscus`, Add `remark-gfm` to dependencies and modify `dumi-theme-lobehub`'s content styles, add ActionIconGroup component, Add Alert, Add Alert component, add Avatar、ListItem components, Add banner prop to Alert component, Add borderRadius and size props to SpotlightCardItem and SpotlightCard components, Add chat input component with event handlers, styling, and props, Add ChatHeader component with specific functionality and styling, add ChatInputArea, add classNames prop to DraggablePanel, Add code highlighting component and update styling in ChatInputArea, Add Collapse, add color scales, add ContextMenu, add Conversation component, Add custom tab, add EditableMessageList component, Add EmojiPicker component and update Avatar component, Add enableResponsive to Modal, Add exrta to Alert, Add FileTypeIcon, add FluentEmoji, Add gap props to SliderWithInput, Add GaussianBackground, Add global styles for font, colors, and scrollbar customization, add GradientButton, Add Grid, Add Image and ImageGallery, Add import statement for 'ChevronDown' icon and expandIcon component, add Input, Add LobeChat Brand, Add LogoThree component to Lobe UI, Add Mdx Components, Add Mermaid, add MessageModal component, Add Meta component for generating meta tags and links, Add new component "Img" and make changes to multiple components and styles, Add new components, modify existing components, and export components, Add new components, props, and styles, Add new dependencies and ErrorBoundary components, Add new dependency, update styles and functionality, and enhance emoji display, Add new features and update multiple components, Add new features to Highlighter and CodeBlock components, Add new features to React components and Markdown module, Add new files and modify existing ones for grid background and showcase, Add new optional props and modify JSX structure and styles in ChatHeader component, Add new prop and update rendering logic in ChatList and ListItem components, Add new props and functionality to components, update styles, and adjust form layout, Add new props and import MessageModal component, Add new props and improve customization options in components, Add new styles and properties to components, Add new styles and props to ChatItem, EditableMessage, and ListItem, Add onClick and style props to Avatar component, Add onDoubleClick prop to multiple components, Add opacity to FormDivider and change background color of mobileGroupBody and MobileTabBar, Add props to LogoThree, add props to MobileChatSendButton, add python support in useHighlight.ts, Add remark-math, Add responsive parameter to useStyles function in src/Form/style.ts, Add showSearch prop to select component, and extand langs, add Snippet, Add SortableList, Add spline logo, add StoryBook mode, Add tooltip delay prop to ActionIcon component, Add TTS hooks, Add upload to EmojiPicker, Add useResponsive hook and conditional rendering in FormGroup and index, Add useState and useEffect hooks to InputHighlight component, Add wrap to highlihter props, Avatar supports ReactNode, better docs theme, ChatInput add `safeArea` prop, ChatList 支持复制与编辑消息，click Show Details can expand text, Enable double-click functionality in Item component, Enhance functionality and usability of ChatInputArea component, Export "getEmoji" function and "neutralColorScales" variable, Implement chat item feature, Implement SpotlightCard component in Lobe UI, Implement theme switch component and add color palettes for different themes, Import `useHover` and `useRef` hooks, update `displayMode` prop, use `useHover` in `TokenTag` component, and modify component styling, Import component, add and remove features, modify code, and update tsconfig.json, Introduce conditional rendering and new components, Introduce Flexbox component and conditional rendering in Logo component, Introduce new features and make code updates in multiple files, Introduce SelectWithImg component and export various components, markdown support custom components by componentProps, Modify border color in ChatHeader and update "pin" variable in DraggablePanel, Modify image attributes and add new Img component, Pref using react lazy, Rename usePressSpeechRecognition to usePersistedSpeechRecognition, Replace 'Nav' component with 'GroupNav' component, support imgUnoptimized in CP, support rsc usage, Update Burder, Update Changelog.md and package.json, Update ChatList onActionsClick, Update CSS styles in MobileNavBar and MobileTabBar components, Update dependencies and import modules for package.json, SyntaxHighlighter, Markdown component, and useHighlight hook, Update fill prop in SvgIcon and modify Flexbox props in ListItem, Update fluent emoji, Update FluentEmoji cdn, Update Logo render, Update mdx components to next rsc, Update Modal components, Update SearchBar, update SearchBar style, Update tts hooks, use memo wrapper in markdown, Use ReactSVG to load svg logos, 优化 EditableText 与 ControlInput 组件以支持标题编辑需求，兼容插件模式，初始化基础组件，支持 InputArea 右侧区域的自定义，支持 loading 渲染，支持 renderMessageExtra, 支持展示 token 使用量，新增 EditableText、SearchBar 组件，新增 Highlighter、Markdown 组件，新增 MessageInput、Swatches 组件，暴露 Form 子组件.
...
- **list-item**: Fix type.
- **toc**: Fix top style.
- **misc**: `onBlur` does not work, Add "onAvatarsClick" prop to ChatList component, Add checkSyntax in Mermaid, Add exports for two functions and rename export function, add image props for EmptyCard, add lost dependencies, add missing deps, Add optional parameters for "onActionClick" function, add ref to avatar, add types, add types, alert contents should not break in the middle of a word, Avatar base64 src, ChatInputArea should add maxHeight api, Clean console log, clean deps, do not break in-between words in tooltips, Don't trim codeBlock, DraggablePanelHeader children not working, Drawer in pwa, Extra Backslash in Code Blocks ($0 -> /$0), fix `desc` layout issue of `Form`, Fix ActionBar, Fix antd 5.7.1 ButtonProps, fix antd as peer not deps, fix ApiHeader encodeURIComponent, Fix Avatar alt, Fix build, Fix build, Fix build, Fix Callout, Fix ChatInputArea expand on mobile, Fix ChatList demo, Fix ChatList map key, Fix ChatList render, fix Delete key, fix demos, fix dependence, Fix deps, Fix deps, fix dir name, fix editable message, Fix EmojiPicker, fix error, Fix eslint, Fix export, Fix form flex, fix form group title type, fix form item label, Fix Form type, Fix Fullscreen in PWA, fix Hero and Features components link, Fix highlight, Fix highlight, Fix highlight, Fix highlight, Fix highlight and use bun in workflow, fix Icon display size, fix Image preview=false not working, fix image props for EmptyCard, Fix LaTeX Render, Fix lazy, fix light algorithm, Fix Link type, Fix Logo3d, Fix LogoSpline Props, fix markdown, fix markdown, Fix markdown code style, Fix markdown ol style, Fix md render <p> in <li>, Fix Mdx components export, fix mdx export, Fix mdx image size, Fix mdx Link, fix message modal, Fix MessageInput, fix missing unoptimized for chatItem, fix missing unoptimized for chatItem, fix missing unoptimized for fluentEmoji, fix missing unoptimized in SelectWithImg, fix MobileChatInputArea props type, Fix Modal, Fix Modal height, fix onActionClick props, Fix package, Fix pre wrap in safari, fix recursive deps, fix rsc missing, fix SelectWithImg aria label, Fix sidebar layout, Fix Snippet warp, Fix spline, Fix Spline react, fix SpotlightCard render, fix ssr error, fix ThemeProvider missing style and className, fix tokenTag ref, Fix type, Fix type, Fix type, Fix type, Fix type, Fix type, Fix type, Fix type, Fix type, fix type error, Fix type export, Fix types, fix types, fix types, fix types, fix types, Fix typo, Fix white space in Highlight, Fix XSS, Fix: Fix checkbox style and demo typo, form group children support ReactNode, Handling invalid Markdown bold, hide tooltip on clicking action icon, highlighter scroll bugs, hydration mismatch in grid background, Incorrect math parser, Lock @types/react, make video autoplay, Markdown hard break only in chat mode, message modal, No display of time, No display of time, No display of time on mobile, pin dumi, Refactor Modal component to handle dynamic content height, Remove dependency "rehype-raw", Remove input highlight, remove tts temporally to fix app build, remove unoptimized default props, remove unoptimized default props, rename folder name, rename StroyBook with StoryBook, replace static `prefixCls` with dynamic `prefixCls`, revert svg logo problem, revert to fix, revert version change to static the image cdn cache control, scrolbar, stylelint, support loading onClick, the `props` of the chat input section do not work, The mobile end cannot stop generating, Turn off revalidateOnFocus in swr, Type, type-check, Typo, Update ChatInputArea.tsx, Update getVoiceList.ts, Update index.tsx, Update useHighlight.ts, Update useHighlight.ts, Update useHighlight.ts, Update useHighlight.ts, Update useHighlight.ts, wrapper with client flag, 优化类型，修复 ChatItem 编辑态宽度过小的问题，修复 Highlight 重新初始化的问题，修正 List Item 样式问题，修正 renderMessage 问题，修正找不到 ref 的报错，移除 pangu 依赖，移除不必要的 hover 效果，补充 form props.
...
- **misc**: Add enableGlobalStyle to ThemProvider props, Add markdownProps to ChatItem, Add NavBar variant, Add new options to Alert, Add new props to ChatItem, Add objectFit props to images, Add props to Burger add ActionIcon, Add props to Markdown, Change TokenTag fontfamily, Display mobile `tooltip` correctly, error 兼容移动端样式，export copyToClipboard, Expose `tooltip` overlayStyle prop, fix action-icon spin props not working, Fix cards grid, Fix ChatInputArea style, Fix ChatInputArea style, fix ChatList error scroll error, Fix Collapse style, Fix Collapse style, Fix Collapse style, Fix form style, fix function message width on mobile, Fix global style, Fix image max width in markdown chat mode, Fix inline code style, Fix Input props, fix input style, Fix line height in chat item, Fix ListItem style, Fix Logo combine in safari, Fix markdown header lineheight, fix ol style, fix props, Fix size in MaterialFileTypeIcon, Fix variant in MaterialFileTypeIcon, Fix warp in markdown render, form group support icon ReactNode, Format value in TokenTag, Hide scrollbar, improve css logical properties, improve list pin style, improve styles, Increase gaps between ChatItem, Modify minsacle in image preview, Remove fallback string in chatitem, Remove image hover in mobile mode, Remove playholder fallback in editable message, Remove styled-components and dayjs locales define, Rename Form itemsType, Searchbar support loading, support hard breaks, tiny fix, update `SyntaxHighlighter` and `form`, Update Callout style, Update ChatHeader, Update ChatHeader style, Update CSS styles for ChatItem component and override Ant Design styles, Update FONT_CODE in baseTheme to use ui-monospace, Update Form, Update Form, Update Form style, Update generateCustomStylish.ts, Update generateCustomStylish.ts, Update generateCustomStylish.ts, Update generateCustomStylish.ts, Update GridShowcase, Update GridShowcaseProps, Update LogoThree loading, Update Markdown, Update Markdown demos and fix SearchBar style, Update markdown footernote style, Update markdown image style, Update Markdown style and add more Mdx components, Update mdx components props, Update mdx style, Update mdx style, Update mdx style, Update MessageInput style, Update Mobile Compinents, Update MobileChatInputArea, Update Modal and Form style, update modal style, Update pin style, update scrollbar, Update SortableList Style, Update style files, Update style files in DocLayout and related components, Update stylelint, Update styles for components, Update styles for form, message modal, and search bar components, Update table minwidth, Update Table style, Update Tabs props, Use dvh instand of vh, 优化 Chat Error 展示样式，优化 ChatList ActionBar 数量，优化 Swatch 分割线颜色，优化 tag 样式，优化组件.
...
- **avatar**: Update Avatar border color ([dd99c25](https://github.com/unitalkai/lobe-ui/commit/dd99c25))
- **dumi-theme-lobehub**: Update Content style for headings and paragraphs ([56cb2c6](https://github.com/unitalkai/lobe-ui/commit/56cb2c6))
- **font**: Better font render ([de9966d](https://github.com/unitalkai/lobe-ui/commit/de9966d))
- **input**: Update background-color logic for block type input ([6dacaaa](https://github.com/unitalkai/lobe-ui/commit/6dacaaa))
- **logo**: Update Logo component ([552deb6](https://github.com/unitalkai/lobe-ui/commit/552deb6))
- **package.json**: Add stylelint and lint:fix scripts ([32bd81a](https://github.com/unitalkai/lobe-ui/commit/32bd81a))
- **package.json**: Update dependencies and lint scripts ([eb6a5d3](https://github.com/unitalkai/lobe-ui/commit/eb6a5d3))
- **readme**: Add text-alignment and word-wrap to p tags ([98887cb](https://github.com/unitalkai/lobe-ui/commit/98887cb))
- **src/highlighter/theme.ts**: Update color variables for better readability ([8b022c5](https://github.com/unitalkai/lobe-ui/commit/8b022c5))
- **syntaxhighlighter**: Update variable name in codeToHtml ([92eb4a3](https://github.com/unitalkai/lobe-ui/commit/92eb4a3))
- **theme**: Remove commented code, update editor foreground color ([7756743](https://github.com/unitalkai/lobe-ui/commit/7756743))
- **theme**: Update font variables in base theme ([9b53c78](https://github.com/unitalkai/lobe-ui/commit/9b53c78))
- **tokens**: Update color and border values in token files ([1ebcb83](https://github.com/unitalkai/lobe-ui/commit/1ebcb83))
- **tokens**: Update color palette and gray scale colors ([f8f5de0](https://github.com/unitalkai/lobe-ui/commit/f8f5de0))
...
- **misc**: Remove styled-components and dayjs locales define ([c917ec5](https://github.com/unitalkai/lobe-ui/commit/c917ec5))
...
- **misc**: Update FONT_CODE in baseTheme to use ui-monospace ([38f4f89](https://github.com/unitalkai/lobe-ui/commit/38f4f89))
...
- **misc**: Update scrollbar ([bbc845a](https://github.com/unitalkai/lobe-ui/commit/bbc845a))
